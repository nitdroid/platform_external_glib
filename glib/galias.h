...
extern __typeof (g_sequence_self_test_internal_to_glib_dont_use) IA__g_sequence_self_test_internal_to_glib_dont_use __attribute((visibility("hidden")));
#define g_sequence_self_test_internal_to_glib_dont_use IA__g_sequence_self_test_internal_to_glib_dont_use
...
extern __typeof (g_regex_free) IA__g_regex_free __attribute((visibility("hidden")));
#define g_regex_free IA__g_regex_free

extern __typeof (g_regex_optimize) IA__g_regex_optimize __attribute((visibility("hidden")));
#define g_regex_optimize IA__g_regex_optimize

extern __typeof (g_regex_copy) IA__g_regex_copy __attribute((visibility("hidden")));
#define g_regex_copy IA__g_regex_copy
...
extern __typeof (g_regex_clear) IA__g_regex_clear __attribute((visibility("hidden")));
#define g_regex_clear IA__g_regex_clear
...
extern __typeof (g_regex_match_next) IA__g_regex_match_next __attribute((visibility("hidden")));
#define g_regex_match_next IA__g_regex_match_next

extern __typeof (g_regex_match_next_full) IA__g_regex_match_next_full __attribute((visibility("hidden")));
#define g_regex_match_next_full IA__g_regex_match_next_full
...
extern __typeof (g_regex_get_match_count) IA__g_regex_get_match_count __attribute((visibility("hidden")));
#define g_regex_get_match_count IA__g_regex_get_match_count

extern __typeof (g_regex_is_partial_match) IA__g_regex_is_partial_match __attribute((visibility("hidden")));
#define g_regex_is_partial_match IA__g_regex_is_partial_match

extern __typeof (g_regex_fetch) IA__g_regex_fetch __attribute((visibility("hidden")));
#define g_regex_fetch IA__g_regex_fetch

extern __typeof (g_regex_fetch_pos) IA__g_regex_fetch_pos __attribute((visibility("hidden")));
#define g_regex_fetch_pos IA__g_regex_fetch_pos

extern __typeof (g_regex_fetch_named) IA__g_regex_fetch_named __attribute((visibility("hidden")));
#define g_regex_fetch_named IA__g_regex_fetch_named

extern __typeof (g_regex_fetch_named_pos) IA__g_regex_fetch_named_pos __attribute((visibility("hidden")));
#define g_regex_fetch_named_pos IA__g_regex_fetch_named_pos

extern __typeof (g_regex_fetch_all) IA__g_regex_fetch_all __attribute((visibility("hidden")));
#define g_regex_fetch_all IA__g_regex_fetch_all
...
extern __typeof (g_regex_split_next) IA__g_regex_split_next __attribute((visibility("hidden")));
#define g_regex_split_next IA__g_regex_split_next

extern __typeof (g_regex_split_next_full) IA__g_regex_split_next_full __attribute((visibility("hidden")));
#define g_regex_split_next_full IA__g_regex_split_next_full

extern __typeof (g_regex_expand_references) IA__g_regex_expand_references __attribute((visibility("hidden")));
#define g_regex_expand_references IA__g_regex_expand_references
